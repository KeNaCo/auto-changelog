...
@click.option('--issue-pattern', default=r'(#([\w-]+))', help='Override regex pattern for issues in commit messages. Should contain two groups, original match and ID used by issue-url.')
